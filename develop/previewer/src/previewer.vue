    ...
    <div class="previewer" id="previewer-cover">
        <transition name="cover">
            <div
                ...
                <span class="arrow tofu-icon icon-point-left" @click="switchImage('left')"></span>
                <span class="arrow tofu-icon icon-point-right" @click="switchImage('right')"></span>
                <!--<div class="description">test</div>-->
                <!--<div class="loading">This is loading.</div>-->
                <img
...
export default {
    ...
    methods: {
        ...
        registerListener () {
            ...
            let self = this;
            this.images = Array.from(images).map((image, idx) => {
                ...
                if (this.justPreview) {
                    ...
                    setTimeout(() => {
                        ...
                        if (this.direction === 'left') {
                            ...
                            el.style.right = `${this.size.windowWidth / 2}px`;
                            el.style.transform = `translate(50%, -50%) scale(1)`;
                        }
                        done();
                    }, 20);
                    ...
                    setTimeout(() => {
                        ...
                        if (this.direction === 'left') {
                            ...
                            el.style.transform = `translate(-50%, -50%) scale(${scaleRadio})`;
                        } else {
                            el.style.right = `${windowWidth / 2}px`;
                            el.style.transform = `translate(50%, -50%) scale(${scaleRadio})`;
                        }
                        done();
                    }, 20);
        ...
        // enter (el, done) {
        //     debugger
        //     let curImg = this.$refs[`image_${this.curImgIdx}`].$el;
        //     const rect = curImg.el.getBoundingClientRect();
        //     const windowHeight = document.body.clientHeight;
        //     const windowWidth = document.body.clientWidth;
        //     const galleryHeight = windowHeight - 88;
        //     const scaleRadio = galleryHeight / rect.height;
        ...
        leave (el, done) {
            if (this.isSwitch) {
                ...
                if (this.justPreview) {
                    ...
                    let curImg = this.images[this.oldImgidx];
                    const rect = curImg.el.getBoundingClientRect();
