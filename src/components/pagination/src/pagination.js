...
import ElSelect from '../../select/src/select';
...
export default {
    ...
    render(h) {
        ...
        const rightWrapper = <div class="el-pagination-rightwrapper"></div>;
    ...
    components: {
        ...
        Sizes: {
            ...
            render(h) {
                return (
                    <span class="el-pagination-sizes">
            <ElSelect
                size="small"
        ...
        Total: {
            render(h) {
                return (
                    <span class="el-pagination-total">{ $t('el.pagination.total', { total: this.$parent.total }) }</span>
                );
            }
        },
