<template>
  ...
  >
    <div class="el-submenu-title" ref="submenu-title" @click="handleClick" :style="paddingStyle">
      <slot name="title"></slot>
      <i
        :class="{
        'el-submenu-icon-arrow': true,
      ...
      <template v-if="rootMenu.mode === 'horizontal' || (rootMenu.mode === 'vertical' && rootMenu.collapse)">
        <transition :name="menuTransitionName">
            <div class="el-menu-vertical" v-show="opened">
                <ul class="el-menu">
                <slot></slot>
            </ul>
        </div>
...
<script>
import ElCollapseTransition from "../../../utils/transition";
