<template>
    <label class="el-switch" :class="{ 'is-disabled': disabled, 'el-switch-wide': hasText, 'is-checked': checked }">
        <div class="el-switch-mask" v-show="disabled"></div>
        <input class="el-switch-input"
               ...
               :disabled="disabled">
        <span class="el-switch-core" ref="core" :style="{ 'width': coreWidth + 'px' }" @click="setFocus">
      <span class="el-switch-button" :style="{ transform }"></span>
    </span>
